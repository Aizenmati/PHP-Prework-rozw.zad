...
for ($i = 0; $i < $n; $i++) {
    $row = '&nbsp;' . '<br>';//zmienna która jest zerowana na początku każdej iteracji, przechowująca gwiazdki z wiersza
    //tworzymy pętlę generującą nam gwiazdki w wierszu
    for ($j = 0; $j < $n; $j++) {
        $row .= '* ';
    }
    echo $row . '<br>';//wyświetlamy gwiazdki z wiersza i dodajemy "enter"
}
?>
